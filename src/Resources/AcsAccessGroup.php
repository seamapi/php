        ...
        public static function from_json(mixed $json): AcsAccessGroup|null
        {
            ...
            return new self(
                ...
                access_schedule: isset($json->access_schedule)
                    ? AcsAccessGroup\AccessSchedule::from_json(
                ...
                errors: array_map(
                    fn($e) => AcsAccessGroup\Errors::from_json($e),
                    $json->errors ?? [],
                ),
                ...
                pending_mutations: array_map(
                    fn($p) => AcsAccessGroup\PendingMutations::from_json($p),
                    $json->pending_mutations ?? [],
                ),
                warnings: array_map(
                    fn($w) => AcsAccessGroup\Warnings::from_json($w),
                    $json->warnings ?? [],
                ),
