    ...
    class Errors
    {
        public static function from_json(mixed $json): Errors|null
        {
            ...
            return match ($discriminant) {
                ...
                \Seam\Resources\AccessCode\Errors\ErrorCode::CODE_CONSTRAINTS_VIOLATED
                    => \Seam\Resources\AccessCode\Errors\CodeConstraintsViolated::from_json(
                    $json,
                ),
                \Seam\Resources\AccessCode\Errors\ErrorCode::FAILED_TO_ISSUE
                    => \Seam\Resources\AccessCode\Errors\FailedToIssue::from_json(
                    $json,
                ),
                \Seam\Resources\AccessCode\Errors\ErrorCode::FAILED_TO_UPDATE
    ...
    class Warnings
    {
        public static function from_json(mixed $json): Warnings|null
        {
            ...
            return match ($discriminant) {
                ...
                \Seam\Resources\AccessCode\Warnings\WarningCode::DELAY_IN_ISSUING
                    => \Seam\Resources\AccessCode\Warnings\DelayInIssuing::from_json(
                    $json,
                ),
...
namespace Seam\Resources\AccessCode\Errors {
     ...
     */
    final class FailedToIssue extends \Seam\Resources\AccessCode\Errors
    {
     ...
     */
    final class FailedToUpdate extends \Seam\Resources\AccessCode\Errors
    {
...
namespace Seam\Resources\AccessCode\Warnings {
     ...
     */
    final class DelayInIssuing extends \Seam\Resources\AccessCode\Warnings
    {
