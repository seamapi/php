...
namespace Seam\Resources {
    ...
    class UnmanagedUserIdentity
    {
        ...
        public function __construct(
             ...
             *
             * @var list<\Seam\Resources\UnmanagedUserIdentity\Errors>
             */
            public array $errors,
            /**
             ...
             *
             * @var list<\Seam\Resources\UnmanagedUserIdentity\Warnings>
             */
...
namespace Seam\Resources\UnmanagedUserIdentity {
    ...
    abstract class Errors
    {
        public static function from_json(mixed $json): Errors|null
        {
            ...
            return match ($discriminant) {
                \Seam\Resources\UnmanagedUserIdentity\Errors\ErrorCode::ISSUE_WITH_ACS_USER
        ...
        public function __construct(
             ...
             */
            public \Seam\Resources\UnmanagedUserIdentity\Errors\ErrorCode|string|null $error_code,
            /**
    ...
    abstract class Warnings
    {
        public static function from_json(mixed $json): Warnings|null
        {
            ...
            return match ($discriminant) {
                \Seam\Resources\UnmanagedUserIdentity\Warnings\WarningCode::BEING_DELETED
                    => \Seam\Resources\UnmanagedUserIdentity\Warnings\BeingDeleted::from_json(
                    $json,
                ),
                \Seam\Resources\UnmanagedUserIdentity\Warnings\WarningCode::ACS_USER_PROFILE_DOES_NOT_MATCH_USER_IDENTITY
        ...
        public function __construct(
             ...
             */
            public \Seam\Resources\UnmanagedUserIdentity\Warnings\WarningCode|string|null $warning_code,
        ) {}
    }
}

namespace Seam\Resources\UnmanagedUserIdentity\Errors {
    /**
     * Indicates that there is an issue with an access system user associated with this user identity.
     */
    final class IssueWithAcsUser extends
...
namespace Seam\Resources\UnmanagedUserIdentity\Warnings {
    /**
     * Indicates that the user identity is currently being deleted.
     */
    final class BeingDeleted extends
        \Seam\Resources\UnmanagedUserIdentity\Warnings
    {
