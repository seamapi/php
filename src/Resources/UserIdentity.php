    ...
    abstract class Errors
    {
        public static function from_json(mixed $json): Errors|null
        {
            ...
            return match ($discriminant) {
                ...
                default
                    => \Seam\Resources\UserIdentity\Errors\Unknown::from_json(
                    $json,
                ),
            };
        }
    ...
    abstract class Warnings
    {
        public static function from_json(mixed $json): Warnings|null
        {
            ...
            return match ($discriminant) {
                ...
                default
                    => \Seam\Resources\UserIdentity\Warnings\Unknown::from_json(
                    $json,
                ),
            };
        }
...
namespace Seam\Resources\UserIdentity\Errors {
    ...
    /**
     * Fallback for user_identity.errors values introduced after this SDK version.
     */
    final class Unknown extends \Seam\Resources\UserIdentity\Errors
    {
...
namespace Seam\Resources\UserIdentity\Warnings {
    ...
    /**
     * Fallback for user_identity.warnings values introduced after this SDK version.
     */
    final class Unknown extends \Seam\Resources\UserIdentity\Warnings
    {
        public static function from_json(mixed $json): Unknown|null
        {
            if (!$json) {
