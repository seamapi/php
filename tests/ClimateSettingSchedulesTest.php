...
final class ClimateSettingSchedulesTest extends TestCase
{
  public function testClimateSettingSchedules(): void
  {
    ...
    $climate_setting_schedule_id = $climate_setting_schedules[0]->climate_setting_schedule_id;
    ...
    $this->assertTrue($climate_setting_schedule->climate_setting_schedule_id === $climate_setting_schedule_id);
    ...
    try {
      ...
      $this->assertTrue(str_contains($exception->getMessage(), "climate_setting_schedule_not_found"));
    }
  }
}
